...
print(cal_specific_day_in_the_suburb_speak_lan_with_every_sent("2014-7-25", "2014-7-26","en,in"))
...
print(cal_specific_day_in_the_city_with_every_sent('2022-5-6','2022-5-8'))
