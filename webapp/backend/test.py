...
# print(cal_total_tweets_in_the_suburb_speak_lan_with_every_sent("2022-5-10", "2022-5-14", "fr,en,ja" , "sydney,melbourne,brisbane"))
# print("=================================================================================================================") 
...
print(cal_specific_day_in_the_suburb_speak_lan_with_every_sent("2022-5-10", "2022-5-14"))
...
print(cal_specific_day_in_the_city_with_every_sent('2022-5-10','2022-5-14'))
